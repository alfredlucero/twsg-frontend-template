...
module.exports = {
  webpackFinal: async (baseConfig, options) => {
    ...
    newConfig.module.rules.push({
      test: /\.(ts|tsx)$/,
      include: [path.resolve(__dirname, "../src/components"), path.resolve(__dirname, "../src/**/*.stories")],
      use: [
        {
          loader: "babel-loader",
          options: {
    ...
    // loader deps locked to this https://stackoverflow.com/questions/68580273/type-error-this-getoptions-is-not-a-function-for-style-loader
    //
